...
//******************************************************************************
// Last modified: Wed Feb 12 14:01:05 2020 by Chris Weaver
//******************************************************************************
// Major Modification History:
//
// 20190203 [weaver]:	Original file.
// 20190220 [weaver]:	Adapted from swingmvc to fxmvc.
// 20200212 [weaver]:	Added documentation to loadFXData().
...
public abstract class AbstractPane
{
	...
	// Convenience method to slurp a basic comma separated values (CSV) file
	// as a list of data records. Each data record is itself a list of strings.
	// The url argument should be the file's name or path relative to the
	// FX_TEXT package, as defined in the static member definitions above.
