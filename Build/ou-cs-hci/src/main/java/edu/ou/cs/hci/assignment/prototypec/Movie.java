...
public final class Movie
{
	...
	public List<String>	getAllAttributesAsStrings()
	{
		...
		list.add(getRating());
		list.add(String.valueOf(getRuntime()));
		list.add(String.valueOf(getAwardPicture()));
		list.add(String.valueOf(getAwardDirecting()));
		list.add(String.valueOf(getAwardCinematography()));
		list.add(String.valueOf(getAwardActing()));
		list.add(String.valueOf(getAverageReviewScore()));
		list.add(String.valueOf(getNumberOfReviews()));
		list.add(String.valueOf(getGenre()));
		list.add(getDirector());
		list.add(String.valueOf(getIsAnimated()));
		list.add(String.valueOf(getIsColor()));
		list.add(getSummary());
